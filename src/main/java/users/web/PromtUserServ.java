...
@WebServlet(urlPatterns = {"/PromtUser"})
public class PromtUserServ extends TopServlet{

    static Logger logger = LogManager.getLogger(PromtUserServ.class);
	...
	String message = "";
	appDbInfo = getAppDbInfo("promt");
	PromtUser user = new PromtUser();
